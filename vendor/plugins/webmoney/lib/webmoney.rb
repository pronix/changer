  ...
  def interface_urls
    {
      ...
      :create_transaction  => (classic? ? (classic_url+"XMLTrans.asp") : (light_url+"XMLTransCert.asp")) , # x2
      ...
      :balance             => (classic? ? (classic_url+"XMLPurses.asp") : (light_url+"XMLPursesCert.asp") ), # x9
