...
class Admin::CurrenciesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Currency: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Currency: create, read, update, custom_action_for_an_item
  #
