...
class Admin::PathWaysController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     PathWay: create, read, update, destroy, custom_action
  #
  #   editor:
  #     PathWay: create, read, update, custom_action_for_an_item
  #
